...
## Cau truc thu muc
- `raw/{lang,math}/bug_N/{buggy,fixed}/` : ma nguon tung bug, ban loi va ban sua
- `mutation/{lang,math}/bug_N/` : ket qua mutation chi tiet (kill.csv, mutants.log, summary.csv)
- `full_ground_truth.csv` : bang tong hop 150 bug (file chinh)
- `pilot_ground_truth.csv` : 10 bug Lang pilot
- `excluded_bugs.txt` : danh sach bug bi loai
